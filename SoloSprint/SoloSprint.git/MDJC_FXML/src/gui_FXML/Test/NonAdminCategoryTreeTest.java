...
public class NonAdminCategoryTreeTest
{
	...
	@Test
	//Make sure that, if plan is not editable and user is NOT admin, button to add category is disabled
	void addCategoryButtonTest(FxRobot robot)
	{
		robot.clickOn("#addCategoryButton");
		
		assertThat(robot.lookup("#addCategoryButton").queryButton().isDisabled()).isTrue();
