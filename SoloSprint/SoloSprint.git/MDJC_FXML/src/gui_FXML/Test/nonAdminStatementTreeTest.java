...
public class nonAdminStatementTreeTest
{
	...
	@Test
	//Making sure context menu functions still work if the user is not an admin and plan is editable
	void contextMenuFunctionsTest(FxRobot robot)
	{
	...
	@Test
	//Making sure context menu functions are disabled for nonAdmin if the plan is not editable
	//Statement info should still show though
	void disableNonEditTest(FxRobot robot)
	{
